...
function! RunSingleConque(command)
  ...
  endtry
  let g:single_conque = conque_term#open(a:command, ['belowright vsplit', 'vertical-resize 40'])
endfunction
...
command RspecFile :call RunRspecCurrentFileConque()
command RspecLine :call RunRspecCurrentLineConque()
